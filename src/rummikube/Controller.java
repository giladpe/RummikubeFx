...
import rummikube.XmlOptions.xml;
...
import rummikube.oldView.MainMenu;
import rummikube.oldView.SubMenu;
import rummikube.oldView.View;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    private void loadGameFromXml() throws JAXBException, SAXException, FileNotFoundException {
        ...
        savedRummiKubGame = xml.getSavedGame(userInput);
